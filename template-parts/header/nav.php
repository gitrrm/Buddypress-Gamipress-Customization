...
<header id="masthead" class="site-header container bg-white overflow-hidden pb-3 pt-3" role="banner"> 
	...
	<nav id="site-navigation" class="main-navigation float-start inline-block border-box">
		<button class="menu-toggle ms-5" aria-controls="primary-menu" aria-expanded="false">
